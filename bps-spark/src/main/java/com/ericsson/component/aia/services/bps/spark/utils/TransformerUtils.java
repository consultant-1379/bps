...
public class TransformerUtils {
    ...
    public static String transform(final StructType stuct, final String[] split) {
        ...
        LOG.trace("Exiting from the method ");
    ...
    public static String buildDDL(final StructType stuct, final String[] split, final String tableName, final String format) {
        //TODO : provide prope implementation of HIVE and format support
        // due to spark 2.1 api level changes we are doing is
        //approach https://forums.databricks.com/questions/11027/spark-210-append-to-hive-table.html
     ...
     *
     * @param stuct
     *            schema from the spark {@link Dataset}
     * @param split
    ...
    public static String filterSchema(final StructType stuct, final String[] split) {
        ...
        LOG.trace("Exiting from the filterSchema method ");
    ...
    public static String filterPartitions(final StructType struct, final String[] split) {
        ...
        LOG.trace("Exiting from the filterPartitions method ");
        return buldeDef.apply(newSet);
    }
