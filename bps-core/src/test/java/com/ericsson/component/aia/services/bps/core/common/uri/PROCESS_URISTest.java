...
public class PROCESS_URISTest {
    ...
    public void testValidSupportedURI() {
        ...
        assertEquals(PROCESS_URIS.SPARK_BATCH_SQL, PROCESS_URIS.fromString("spark-batch-sql://"));
    ...
    public void testDecodeURI() {
        ...
        final URIDefinition<PROCESS_URIS> decode = PROCESS_URIS.decode(sparkBatch, Constants.REGEX);
