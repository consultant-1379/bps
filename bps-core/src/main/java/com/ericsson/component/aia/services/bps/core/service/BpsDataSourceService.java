...
public interface BpsDataSourceService<C, O> extends GenericService {
    ...
    /**
     *   This operation will do the clean up for datasource.
     */
    void cleanUp();

    /**
     * This method will return the properties of the data source service
     *
     * @return the properties associated with data source service      
     */
